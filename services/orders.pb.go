...
func (x *OrdersResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_orders_proto_rawDesc = []byte{
	...
	,
	...
	0x11, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x2f, 0x63, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2e, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
...
var file_orders_proto_goTypes = []interface{}{
	(*OrdersResponse)(nil), // 0: services.OrdersResponse
	(*OrderMain)(nil),      // 1: services.OrderMain
}
var file_orders_proto_depIdxs = []int32{
	1, // 0: services.OrdersService.CreateOrder:input_type -> services.OrderMain
	0, // 1: services.OrdersService.CreateOrder:output_type -> services.OrdersResponse
...
type OrdersServiceClient interface {
	CreateOrder(ctx context.Context, in *OrderMain, opts ...grpc.CallOption) (*OrdersResponse, error)
}
...
func (c *ordersServiceClient) CreateOrder(ctx context.Context, in *OrderMain, opts ...grpc.CallOption) (*OrdersResponse, error) {
	out := new(OrdersResponse)
	err := c.cc.Invoke(ctx, "/services.OrdersService/CreateOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrdersServiceServer interface {
	CreateOrder(context.Context, *OrderMain) (*OrdersResponse, error)
}
...
func (*UnimplementedOrdersServiceServer) CreateOrder(context.Context, *OrderMain) (*OrdersResponse, error) {
...
func _OrdersService_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.OrdersService/CreateOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServiceServer).CreateOrder(ctx, req.(*OrderMain))
	}
	return interceptor(ctx, in, info, handler)
}

var _OrdersService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "services.OrdersService",
